...
namespace Cysharp.Threading
{
    ...
    {
        [ThreadStatic] [CanBeNull] private static LogicLooperCoroutineActionContext _current;

        [CanBeNull] internal static LogicLooperCoroutineActionContext Current => _current;
        ...
        internal static void SetCurrent([CanBeNull] LogicLooperCoroutineActionContext context)
        {
            _current = context;
        }
